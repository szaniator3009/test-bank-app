...
describe('TransactionsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TransactionsBoardComponent, TransactionsListComponent, FilterComponent],
  ...
  it('should call transactions service with no transactions', fakeAsync(() => {
    ...
    spyOn(transactionsService, 'getAccountsEvents$').and.returnValue(of(mockAccountEvents));
    component.ngOnInit();
    tick(2000);
  ...
  it('should call transactions service with some transactions', fakeAsync(() => {
    let mockAccountEvents: AccountEvents = {
      data: [{ merchant: { name: 'test1' } }, { merchant: { name: 'test2' } }, { merchant: { name: 'test3' } }],
    };
    spyOn(transactionsService, 'getAccountsEvents$').and.returnValue(of(mockAccountEvents));
    component.ngOnInit();
    tick(2000);
